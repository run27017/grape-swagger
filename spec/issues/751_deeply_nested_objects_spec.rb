...
describe '751 deeply nested objects' do
  ...
  describe 'Correctness of vrp Points' do
    let(:get_points_response) { subject['components']['schemas']['postVrpSubmit']['properties']['vrp']['properties']['points'] }
    specify do
  ...
  describe 'Correctness of vrp Services' do
    let(:get_service_response) { subject['components']['schemas']['postVrpSubmit']['properties']['vrp']['properties']['services'] }
    specify do
